            ...
            <div className="recipe-detail-card">
                ...
                <div className="recipe-content-container">
                    ...
                    <div className="recipe-actions-section">
                        ...
                        <button className={`recipe-action-btn save`} onClick={() => handleStatus(recipe.id, "rejected")}>
                            Hủy
                        </button>
                        <button className="recipe-action-btn report" onClick={() => handleStatus(recipe.id, "active")}>
                            Xác nhận duyệt
                        </button>
                    </div>
